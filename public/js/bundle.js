...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var alert = "<div class='alert alert--".concat(type, "'>").concat(msg, "</div>");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('http://localhost:5000/api/v1/users/signup', userData);
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Signup up successfully , Login now');
              setTimeout(function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.post('http://localhost:5000/api/v1/users/login', {
              email: email,
              password: password
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _axios.default.get('http://localhost:5000/api/v1/users/logout');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"passwprd.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('http://localhost:5000/api/v1/users/forgotPassword', {
              email: email
            });
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userInfo) {
    var qs, token, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            qs = window.location.pathname.split('/');
            token = qs[qs.length - 1];
            _context2.prev = 2;
            _context2.next = 5;
            return _axios.default.patch("http://localhost:5000/api/v1/users/resetPassword/".concat(token), userInfo);
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(updateData, type) {
    var url, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return _axios.default.patch(url, updateData);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"map.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmF6YS13ZWJkZXYiLCJhIjoiY2xkMGlubW82MDMzZjNwcDluMmxwdjR2MyJ9.2th161HTgxniZec8he1OSQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/raza-webdev/clon9ohdm00d201o4hrrc69j5',
    scrollZoom: false,
...
},{}],"stripeSession.js":[function(require,module,exports) {
"use strict";
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var stripe, _yield$axios$get, session;

    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LiCsYSADekrM2KGwVbaa9gFQntfQNaKxGkoROroiqk713JNDu6aUBqVEsgbCyz7mK5ww1ULX5KHhjLZ99rmg1lx00GRIQZmMc');
            _context.prev = 1;
            _context.next = 4;
            return _axios.default.get("http://localhost:5000/api/v1/bookings/checkout-session/".concat(tourId));

          case 4:
            _yield$axios$get = _context.sent;
            session = _yield$axios$get.data.session;
...
var _passwprd = require("./passwprd");

var _updateSetting = require("./updateSetting");

var _map = require("./map");

var _stripeSession = require("./stripeSession");
...
var userPasswordFrom = document.querySelector('.form-user-password');
var mapContainer = document.getElementById('map');
var logoutBtn = document.querySelector('.nav__el--logout');
var btnBookTour = document.getElementById('btn-booktour'); // DELEGATION
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var confirmPassword = signupForm.querySelector('.confirmPassword').value;
    (0, _login.signup)({
      name: name,
      email: email,
      password: password,
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = forgotPasswordForm.querySelector('.email').value;
    console.log(forgotPasswordForm);
    console.log(email);
    (0, _passwprd.forgotPassword)(email);
  });
}
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var password = resetPasswordForm.querySelector('.password').value;
    var confirmPassword = resetPasswordForm.querySelector('.confirmPassword').value;
    (0, _passwprd.resetPassword)({
      password: password,
      confirmPassword: confirmPassword
    });
  });
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // we are creating formdata for taking image file

    var data = new FormData();
    data.append('name', document.querySelector('.form-user-data #name').value);
    data.append('email', document.querySelector('.form-user-data #email').value);
    data.append('photo', document.querySelector('#photo').files[0]);
    (0, _updateSetting.updateSettings)(data, 'data');
  });
}

if (userPasswordFrom) {
  userPasswordFrom.addEventListener('submit', /*#__PURE__*/function () {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "37518" + '/');
